...
const Team = ({ }) => (
  <div>
    ...
    <div className="member">
      <img className="member_photo" src='https://imgur.com/download/WN4Gd7L' alt="Of Fleisher"/>
  ...
  <div className="member">
    <img className="member_photo" src='https://imgur.com/download/oS7GpfK' alt="Dror Ayalon"/>
