        ...
        <div className="row">
          <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
            <center>
              ...
              <p>
                Individual winners will receive $1,000 per semester to develop a
                project or a tool for two semesters (full academic year). Groups
                will receive $2,000 to develop a project or a tool per semester
                for two semsters.
              </p>
            </center>
          </div>
          ...
          <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
            <center>
              ...
              <p>
                ...
                and the ITP alumni network, will be assigned to each project or
                tool. These mentors will be available for the developers of the
                project and will assist in the project development and guidance.
              </p>
            </center>
          </div>
        </div>
